    ...
    public class WhenGettingFrameworks
    {
        ...
        public async Task Then_Returns_Frameworks_From_Api()
        {
            ...
            var apiResponse = new GetFrameworksApiResponse
            {
                ...
                {
                    new GetFrameworksListItem{FrameworkCode = 2, Title = "Best skills ever", Level = 23, EffectiveTo = DateTime.Today},
                    new GetFrameworksListItem{FrameworkCode = 24, Title = "Best skills everest", Level = 2, EffectiveTo = DateTime.Today},
                    new GetFrameworksListItem{FrameworkCode = 223, Title = "Best skills everer", Level = 1, EffectiveTo = DateTime.Today},
                    new GetFrameworksListItem{FrameworkCode = 233, Title = "Best skills everestest", Level = 3},
                }
            };
