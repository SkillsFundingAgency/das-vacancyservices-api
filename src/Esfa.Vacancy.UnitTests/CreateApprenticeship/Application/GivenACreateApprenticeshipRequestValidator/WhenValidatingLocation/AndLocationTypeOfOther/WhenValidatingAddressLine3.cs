    ...
    public class WhenValidatingAddressLine3
    {
        private static List<TestCaseData> TestCases() =>
            new List<TestCaseData>
            {
                ...
                new TestCaseData(new string('a', 301), false, "'Address Line3' must be less than 301 characters. You entered 301 characters.")
                    .SetName("And exceeds 300 characters Then is invalid"),
                new TestCaseData("<p>", false, "'Address Line3' can't contain invalid characters")
        ...
        public void ValidateAddressLine3(string addressLine3, bool isValid, string errorMessage)
        {
            ...
            if (isValid)
            {
                sut.ShouldNotHaveValidationErrorFor(r => r.AddressLine3, request);
            }
            else
            {
                sut
