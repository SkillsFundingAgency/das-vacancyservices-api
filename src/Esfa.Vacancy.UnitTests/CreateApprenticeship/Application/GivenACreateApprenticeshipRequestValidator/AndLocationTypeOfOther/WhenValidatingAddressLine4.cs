    ...
    public class WhenValidatingAddressLine4
    {
        private static List<TestCaseData> TestCases() =>
            new List<TestCaseData>
            {
                ...
                new TestCaseData(LocationType.OtherLocation, false, new string('a', 301),  "31041").SetName("And exceeds 300 characters Then is invalid"),
                new TestCaseData(LocationType.OtherLocation, false, "<p>", "31042").SetName("And contains illegal chars Then is invalid"),
